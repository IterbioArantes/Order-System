...
import projeto.spring.jpa.entities.Payment;
...
import projeto.spring.jpa.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Payment payment = new Payment(null, Instant.parse("2019-07-22T15:21:22Z"), o1);
